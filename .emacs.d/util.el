...
(defconst util::base64-chars "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/")
    ...
    (cl-loop for i from 0 below len by 3
             do (lexical-let* ((n (+ (lsh (aref padded-bytes i) 16)
                  ...
                  (setq result (concat result
                                       (char-to-string (aref util::base64-chars n1))
                                       (char-to-string (aref util::base64-chars n2))
                                       (char-to-string (aref util::base64-chars n3))
                                       (char-to-string (aref util::base64-chars n4)))))
